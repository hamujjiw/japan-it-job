      ...
      >
        ...
        <div className="drawer-body">
          ...
          <div className="section">
            ...
            <p className="note">
              Indeed dan LinkedIn tidak mengizinkan datanya disalin, jadi tombol di atas
              membuka pencarian mereka dengan kata kunci posisi dan perusahaan yang sudah
              terisi.
            </p>
          </div>
        </div>
