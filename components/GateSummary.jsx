...
/**
 * Versi ringkas dari meter gerbang, untuk di atas daftar lowongan.
    ...
    <section className="shell gate-summary">
      <div className="route">
        <div className="route-head">
          <h2 className="label">Tiga gerbang · {jobs.length} lowongan</h2>
        ...
        <p className="route-foot">
          Hijau berarti gerbang itu terbuka untukmu, kuning bisa diusahakan, merah pudar
