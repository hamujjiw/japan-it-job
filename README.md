# Papan Lowongan IT Jepang

Papan lowongan kerja IT di Jepang yang **terbuka untuk pelamar asing**, dibuat untuk
pelamar dari Indonesia. Tiap baris langsung menjawab dua pertanyaan yang paling
...
| Berkas | Menghasilkan |
| --- | --- |
| `lib/enrich.js` | **Tiga gerbang** (bahasa / lamaran / lokasi), tingkat senioritas dari judul, daftar teknologi yang sudah diseragamkan (`React.js` dan `reactjs` jadi satu), skor keterbukaan 0-100, gaji dalam rupiah |
...
- **Meter gerbang** sebagai elemen penanda. Tiga segmen yang menunjukkan apakah bahasa,
...
```
app/
  layout.js              huruf, metadata, pemasang tema anti-kedip
...
components/
  ...
  Hero.jsx               meter gerbang agregat
...
lib/
  ...
  enrich.js              gerbang, senioritas, teknologi, skor keterbukaan
