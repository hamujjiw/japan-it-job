...
const CATEGORY_RULES = [
  ["Business Analyst & DX", /\b(business analyst|bizdev|business development|business transformation|digital transformation|\bdx\b|business systems analyst|it business partner|ビジネスアナリスト|事業開発)\b/i],
  ...
  ["Backend", /\b(backend|back-end|server side|api engineer|ruby|golang|\bgo\b|java|php|rails|node|software (developer|engineer)|programmer|システムエンジニア)\b/i],
