 ...
 * Ini bagian yang membuat situs tetap berguna tanpa API key apa pun.
 */
...
/**
 * Kalau ANTHROPIC_API_KEY diisi, teks mentah diringkas jadi struktur rapi
 * dalam Bahasa Indonesia. Kalau tidak, fungsi ini mengembalikan null dan
 * pemanggilnya menampilkan teks aslinya.
 */
...

{
  ...
  "syarat_wajib": ["4-6 poin; sebutkan tahun pengalaman dan syarat bahasa kalau ada"],
...
Jangan mengarang informasi yang tidak ada di teks.`;
  ...
  if (!res.ok) {
    throw new Error(`Anthropic API membalas ${res.status}`);
  }
